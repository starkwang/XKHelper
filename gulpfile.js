...
gulp.task('libs', function() {
    return gulp.src(['src/lib/lunr.min.js', 'src/lib/csv.min.js','src/lib/fastclick.js', 'src/lib/data.js', 'src/lib/jquery.js','src/lib/jquery-qrcode.js','src/lib/angular.min.js', 'src/lib/angular-route.min.js', 'src/lib/angular-css.js','src/lib/angular-animate.min.js', 'src/lib/ng-infinite-scroll.min.js'])
        .pipe(concat('lib.js'))
